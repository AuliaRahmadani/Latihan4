...
public class GambarButon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        glashfishBT.setBackground(new java.awt.Color(255, 255, 0));
        glashfishBT.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        javaeeBT.setBackground(new java.awt.Color(255, 0, 0));
        javaeeBT.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        postgresqlBT.setBackground(new java.awt.Color(0, 204, 0));
        postgresqlBT.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        pilihan.setBackground(new java.awt.Color(153, 153, 153));
        pilihan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3" }));
